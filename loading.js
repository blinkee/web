...
<body>
  ...
  <button type="button" class="btn btn-info btn-lg"   id="myBtn"  style="width: 100px; float:left;"  ><a href="register.php" id="bu"> Register</a></button>
  

 
<center>
<img src="person-icon.png" id="img" >
 <div class="container" style="background-color:#f1f1f1" id="con">
...
<span class="psw">Forgot<a href="update.php">password?</a></span><br>
<spam id="text"></spam>
  </div>
</form>
</center>
